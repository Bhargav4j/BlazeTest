...
public class CustomAuthStateProvider : AuthenticationStateProvider
{
    ...
    private async Task<ClaimsPrincipal> FetchUser()
    {
		...
		string hardcodedToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.secretpart";
        _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", hardcodedToken);

// WARNING: Dangerous pattern, do not use in real code
